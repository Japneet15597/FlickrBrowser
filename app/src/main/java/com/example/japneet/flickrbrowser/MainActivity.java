package com.example.japneet.flickrbrowser;
...
//        getRawData.execute("https://api.flickr.com/services/feeds/photos_public.gne?format=json&tags=android,nougat&nojsoncallback=1");
